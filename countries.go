...
func ByName(name string) CountryCode { //nolint:misspell,gocyclo
	...
	case "VU", "VUT", "NHB", "VANUATU", "NH", "NHVU":
		return VUT
	case "VA", "VAT", "HOLYSEEVATICAN", "HOLYSEE", "VATICAN", "VATICANCITYSTATE", "VATICANSTATE", "HOLYSEEVATIKAN", "VATIKAN", "VATIKANCITYSTATE", "VATIKANSTATE", "HOLYSEEVATIKANCITYSTATE", "VATIKANSTADT", "VATICANCITY":
		return VAT
	...
	case "MX", "MEX", "MEXICO", "MEXIKO":
		return MEX
	case "FM", "FSM", "MICRONESIA", "MICRONESIAFEDERATEDSTATESOF", "MICRONESIAFEDST", "MIKRONESIEN", "FEDERATEDSTATESOFMICRONESIA":
		return FSM
	...
	case "ME", "MNE", "MONTENEGRO":
		return MNE
	case "BL", "BLM", "SAINTBARTHELEMY", "STBARTHELEMY", "SAINTBARTHÉLEMY":
		return BLM
	case "SX", "SXM", "SINTMAARTENDUTCH", "SAINTMAARTEN", "SINTMAARTEN", "STMAARTEN":
		return SXM
	case "RS", "SRB", "CSXX", "SERBIA", "SERBIYA", "SERBIEN":
		return SRB
	case "AX", "ALA", "ALANDISLANDS", "ISLANDSALAND", "ALAND", "ÅLANDISLANDS":
		return ALA
